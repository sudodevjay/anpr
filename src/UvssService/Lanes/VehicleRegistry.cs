...
/// the Vehicle Registry page to manage it. Unlike EventLogStore (an
/// explicitly ephemeral "today's log"), this is reference data an operator
/// builds up over time, so it's persisted to a small JSON file rather than
/// lost on every restart.</summary>
